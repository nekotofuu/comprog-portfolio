Public Class Form1
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        EmployeeNum = txtECode.Text
        Department = cbxDept.Text
        PayDate = DateString

        sssDeduct = txtSSS.Text
        philhealthDeduct = txtPhilhealth.Text
        pagibigDeduct = txtPAGIBIG.Text
        taxDeduct = txtTax.Text
        totalDeduct = txtDeduct.Text

        workHours = txtHours.Text
        payRate = txtRate.Text
        basicPay = txtBPay.Text
        netPay = txtNetPay.Text
        Form2.Show()
    End Sub
End Class
